...
const BoardControl: FC<BoardControlProps> = ({ rows, setRows, cols, setCols, mines, setMines, setGameValues }) => {
  ...
  return (
    <div className={styles.BoardControl}>
      ...
      <button className='Button' onClick={setGameValues}>Update</button>
    </div>
  );
}
